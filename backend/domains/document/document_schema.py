...
class DocumentTableBlock:
    ...
    page_number: 선택. table가 특정 페이지에 귀속될 때 채워질 수 있음
...
class DocumentPage:
    ...
    추출기가 page 정보를 제공하면 page_number / text / table_ids 를 채운다.
...
class DocumentSchema:
    ...
    source_type:
        "odl" - 현재 추출 경로 (opendataloader-pdf hybrid 포함)
    ...
    raw_markdown: str | None = None  # .md 원본
    raw_json: dict | list | None = None  # .json 원본

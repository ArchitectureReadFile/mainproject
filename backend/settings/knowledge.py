...
SESSION_RETRIEVAL_TOP_K = _int_env("SESSION_RETRIEVAL_TOP_K", 3)
SESSION_RETRIEVAL_CHUNK_TARGET_CHARS = _int_env(
    "SESSION_RETRIEVAL_CHUNK_TARGET_CHARS", 1200
)
SESSION_RETRIEVAL_CHUNK_MAX_CHARS = _int_env("SESSION_RETRIEVAL_CHUNK_MAX_CHARS", 1500)
SESSION_RETRIEVAL_CHUNK_OVERLAP = _int_env("SESSION_RETRIEVAL_CHUNK_OVERLAP", 120)

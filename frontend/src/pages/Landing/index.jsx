    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="flex flex-col items-center text-center gap-6 mb-16">
        ...
        <div className="flex gap-3 flex-wrap justify-center">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-colors"
          >
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
        <div className="p-6 border rounded-xl flex flex-col gap-2">
          ...
          <p className="text-sm text-gray-500">PDF 파일을 드래그 앤 드롭하여 쉽게 업로드</p>
        ...
        <div className="p-6 border rounded-xl flex flex-col gap-2">
          ...
          <p className="text-sm text-gray-500">EXAONE이 핵심 내용을 자동으로 추출</p>
          <p className="text-sm text-gray-400">
        ...
        <div className="p-6 border rounded-xl flex flex-col gap-2">
          ...
          <p className="text-sm text-gray-500">유사 판례를 즉시 찾아보세요</p>
          <p className="text-sm text-gray-400">

    ...
    <div className={styles.container}>
      <form onSubmit={onSubmit} className={styles.form}>
        ...
        <div className={styles.field}>
          ...
          {!isLogin && emailVerify.error && <p className={styles.verifyError}>{emailVerify.error}</p>}
          {!isLogin && emailVerify.success && <p className={styles.verifySuccess}>{emailVerify.success}</p>}
        </div>
      ...
      {isLogin && (
        <>
          ...
          <div className={styles.socialGroup}>
            <button
              ...
              <svg width="18" height="18" viewBox="0 0 18 18">
                ...
                />
                <path
                  d="M9 18c2.43 0 4.47-.8 5.96-2.18l-2.91-2.26c-.8.54-1.83.85-3.05.85-2.34 0-4.32-1.58-5.03-3.71H.95v2.3A8.99 8.99 0 0 0 9 18z"
                  fill="#34A853"
                />
                <path
                  d="M3.97 10.71A5.41 5.41 0 0 1 3.68 9c0-.59.1-1.17.29-1.71V4.99H.95A8.99 8.99 0 0 0 0 9c0 1.45.35 2.82.95 4.01l3.02-2.3z"
                  fill="#FBBC05"
                />
                <path
                  d="M9 3.58c1.32 0 2.5.45 3.44 1.35l2.58-2.58C13.46.89 11.43 0 9 0 5.48 0 2.39 2.02.95 4.99l3.02 2.3c.71-2.13 2.69-3.71 5.03-3.71z"
                  fill="#EA4335"
                />
              </svg>
              Google로 계속하기
          ...
          <div className={styles.helpLinks}>
            ...
            <button type="button" onClick={() => setView("resetPassword")}>
              비밀번호 재설정
            </button>
          </div>
        </>
